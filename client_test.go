...
func TestGetMarshallingError(t *testing.T) {
	...
	_, err := Get[mockArticle](context.Background(), server.URL+"/resource/article/1")
...
func TestGet(t *testing.T) {
	...
	art, err := Get[mockArticle](context.Background(), server.URL+"/resource/article/1",
...
func TestDelete(t *testing.T) {
	...
	_, err := Delete[any](context.Background(), server.URL+"/resource/article/1")
	ok(t, err)
}
